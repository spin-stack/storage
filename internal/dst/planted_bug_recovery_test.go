...
func TestPlantedBugBoundaryRegressed(t *testing.T) {
	plantedBug(t, 21, dst.NewBoundaryMonotonicChecker(), "boundary-monotonic", func(s *dst.Sim) error {
		s.Emit(dst.Event{Kind: dst.EventBoundary, Key: "wal/" + plantedVol + "/2/recovery-point.json", Recovered: 40})
		s.Emit(dst.Event{Kind: dst.EventBoundary, Key: "wal/" + plantedVol + "/3/recovery-point.json", Recovered: 12})
		return nil
	})
}
...
func TestPlantedBugBoundaryRewritten(t *testing.T) {
	plantedBug(t, 22, dst.NewBoundaryMonotonicChecker(), "boundary-monotonic", func(s *dst.Sim) error {
		s.Emit(dst.Event{Kind: dst.EventBoundary, Key: "wal/" + plantedVol + "/2/recovery-point.json", Recovered: 40})
		s.Emit(dst.Event{Kind: dst.EventBoundary, Key: "wal/" + plantedVol + "/2/recovery-point.json", Recovered: 41})
		return nil
	})
}
...
func TestPlantedBugDurablePointRegressed(t *testing.T) {
	plantedBug(t, 23, dst.NewDurablePointMonotonicChecker(), "durable-point-monotonic", func(s *dst.Sim) error {
		s.Emit(dst.Event{Kind: dst.EventDurablePoint, Key: "wal/" + plantedVol + "/1/", Recovered: 30})
		s.Emit(dst.Event{Kind: dst.EventDurablePoint, Key: "wal/" + plantedVol + "/1/", Recovered: 29})
		return nil
	})
}
